...
# COMMENTS
{
  ...
  HOME_COMMENT6 = p(strong("URLs:", style = "font-size:13pt"), a("Web Server (http://micloud.kr)", href = "http://micloud.kr", target = "blank"), ", ",
      ...
      tabItems(
        ...
        tabItem(tabName = "home",
                div(id = "homepage", br(), HOME_COMMENT,
                    ...
                    br(),
                    div(tags$img(src="dendrogram.jpg", height = 900, weight = 500), style =  "text-align: center;"),
                    br(),
